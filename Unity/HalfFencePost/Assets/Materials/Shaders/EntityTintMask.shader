Shader "OCB/OcbEntityTintMask"
{
    ...
    SubShader
    {
        ...
        {
            fixed4 rmom = tex2D(_RMOM, IN.uv_RMOM);
            fixed4 albedo = tex2D(_MainTex, IN.uv_MainTex);
            fixed4 emissive = tex2D(_Emissive, IN.uv_Emissive);
            o.Albedo = albedo.rgb + (_Color.rgb - albedo.rgb) * (1.0 - rmom.a);
            o.Emission = emissive.rgb * _EmissionColor.rgb * _EmissionMultiply;
            o.Normal = UnpackNormal(tex2D(_Normal, IN.uv_Normal));
            o.Metallic = 1 - (1 - rmom.g * _MetallicFactor) * _MetallicInvertor;
            o.Smoothness = (1 - rmom.r * _SmoothnessFactor) * _SmoothnessInvertor;
            o.Occlusion = 1 - (1 - rmom.b * _OcclusionFactor) * _OcclusionInvertor;
            o.Alpha = albedo.a;
        }
        ENDCG
    }
